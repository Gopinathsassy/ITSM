...
//            'id' => value('22'),
        ...
        try {
            ...
            $details = [
                ...
                'topic'  => 'Open Ticket Available with the below details and Login With Link : http://itsm.saiteck.in',
                ...
                'created_by' => 'Created By : '.request('created_by'),
...
//        return redirect()->route('user.ticket');
    ...
    public function edit(Request $request,Ticket $ticket)
    {
        ...
        $ticket->user_close_status = request("user_close_status1");
        $ticket->save();
    ...
    public function update(Request $request, Ticket $ticket)
    {
        ...
        if($ticket->status == '7'){
            ...
            $ticket->change_time =value(Carbon::now());
        ...
        // if (request("user_close_status") != ""){
            $ticket->user_close_status = "hello";
        // }else{
        //     $ticket->user_close_status = '';
        // }
