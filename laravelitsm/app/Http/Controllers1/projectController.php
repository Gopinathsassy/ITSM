...
//        $email = request('emailee');
    ...
    {
//        $checkee = User_assign_project::where("project_name", "=", request('project_name'))->get("email");
//        $hh = count($checkee);
//            if($hh != 0){
...
//        $valueee_users = [];
                ...
                $projectee1 = User::all();
                 ...
                 foreach($projectee as $user_assign ){
                     $value[] = User::where("name", "=", $user_assign)->pluck("name");
                 }

//                 foreach($value as $jerry){
                     $valueee_users[] = User::whereNotIn('name', $value)->pluck("name");
//                 }

//                foreach ($projectee1 as $projecte){
//                    foreach ($projectee as $finalproj){
//                        if($projecte->name !== $finalproj->user_name){
//                                $value[] = $projecte->name;
//                        }
//                    }
//                }
//
                return $valueee_users;
