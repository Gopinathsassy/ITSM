...
{{--                                            <td>{{ $user->pass }}</td>--}}
                                            ...
                                            <td>
                                                        ...
                                                        <!--<a href="user/{{ $user->id }}" style="float:inherit; padding-right:55px;color:#3F4254;" data-toggle="modal" data-cloc="{{ $user->name }}" data-cname="{{ $user->email }}" data-psp="{{ $user->created_at }}"  data-myid="{{ $user->id }}"  data-target="#exampleModalCenter_user" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">-->
                                                ...
                                                <a class="btn btn-sm btn-clean btn-icon del" style="float:inherit; padding-right:55px;color:#3F4254;" data-value="{{ $user->id }}" data-token="{{ csrf_token() }}"  title="Delete">
	                                                        <span class="svg-icon svg-icon-md">
	                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="10px" height="24px" viewBox="0 0 24 24" version="1.1">
	                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
	                                                                    <rect x="0" y="0" width="24" height="24"/>
	                                                       ...
	                                                       <label class="label font-weight-bold label-lg label-light-warning label-inline">Delete</label> 
                                                </a>
 ...
 <!--   <div class="modal fade" id="exampleModalCenter_user" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">-->
 ...
 <!--                                   <input class="form-control" type="text" id="cloc" name="cloc">-->
 <!--                               </div>-->
 <!--                           </div>-->
 <!--                           <div class="col">-->
 <!--                               <div class="form-group">-->
 ...
 <!--                                   <input class="form-control" type="text" id="psp" name="psp">-->
 <!--                               </div>-->
 <!--                           </div>-->
