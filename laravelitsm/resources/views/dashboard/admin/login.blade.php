...
<html lang="en">
	...
	<head><base href="../../../">
        ...
        <style>
            body {
                background-image: url({{ asset('assets/media/svg/illustrations/admin.png') }}) ;
			...
			<div class="login login-2 login-signin-on d-flex flex-column flex-column-fluid position-relative overflow-hidden" id="kt_login">
				...
				<div class="login-header py-10 flex-column-auto">
					<div class="container d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between">
						<!--begin::Logo-->
						<a href="#" class="flex-column-auto py-8 py-md-0">
					...
					<div class="container row">
						<div class="col-lg-6 d-flex align-items-center">
							...
							<div class="login-form login-signin">
								...
								<form class="form w-xxl-550px bg-white rounded-lg p-20" action="{{ route('admin.check') }}" method="post" autocomplete="off">
                                    @if(Session::get("Fail"))
                                ...
                                @csrf
									...
									<div class="pb-13 pt-lg-0 pt-5">
										<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Admin Login</h3>
									</div>
									<!--begin::Title-->
									<!--begin::Form group-->
