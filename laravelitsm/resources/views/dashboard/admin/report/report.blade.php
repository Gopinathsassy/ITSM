            ...
            <div class="col-lg-12">
                ...
                <div class="card card-custom">
                      <div class="card-title">
                            <h3 class="card-label" style="margin-top:35px;margin-left:25px;">All Tickets</h3>
                        </div>
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                       <br><br>
                        <div class="card-title">
                            ...
                            <div>
                                <div class="dropdown mr-1" >
                                    <label class="form-control-label"><span class="label label-dark label-inline mr-2">From Date</span></label>                                    <input class="form-control btn btn-light btn-shadow-hover" value="" type="date" id="dailyeee">
                                </div>
                            </div> &nbsp;&nbsp;&nbsp;
                            <div>
                                <div class="dropdown mr-1" >
                                    <label class="form-control-label"><span class="label label-dark label-inline mr-2">To Date</span></label>                                    <input class="form-control btn btn-light btn-shadow-hover" value="" type="date" id="dailyeee">
                                </div>
                            </div> &nbsp;&nbsp;&nbsp;
                            <div>
                                <div class="dropdown mr-1" >
                            ...
                            <div >
                                <div class="dropdown mr-1"  >
                                    <a href="#" id="searchee" style="margin-top:25px;" class="btn btn-light-dark px-6 font-weight-bold">Search</a>
                                </div>
                            </div> &nbsp;&nbsp;&nbsp;
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <div class="dropdown dropdown-inline mr-2">
                                                    ...
                                                    <button style="margin-top:45px;" type="button" class="btn btn-light-dark font-weight-bolder dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!--                                            </li>-->
                    ...
                    <div class="card-body cardee">
                        ...
                        <table class="datatable table-bordered datatable-head-custom" id="kt_datatable">
                            ...
                            <tr style="font-weight:bold;color:#FFFF">
                                <th style="font-weight:bold;color:#FFFF">Ticket ID</th>
                                <th style="font-weight:bold;">Category</th>
                                <th style="font-weight:bold;">Summary</th>
                                <th style="font-weight:bold;">Create On</th>
                                <th style="font-weight:bold;">Assigned On</th>
                                <th style="font-weight:bold;">Completed On</th>
                                <th style="font-weight:bold;">Response Time</th>
                                <th style="font-weight:bold;">Resolution Time</th>
                                <th style="font-weight:bold;">Client Name</th>
                                <th style="font-weight:bold;">Modules</th>
                                <th style="font-weight:bold;">User</th>
                                <th style="font-weight:bold;">Consultant</th>
                                 <th style="font-weight:bold;">Consultant Solution</th>
                                 <th style="font-weight:bold;">user Solution</th>
                            ...
                            @foreach($tickets as $ticket)
                                ...
                                <tr>
                                   <td>{{ $ticket->project }}_{{ $ticket->modulename }}_{{ date('my', strtotime($ticket->created_at)) }}_{{ $ticket->id }}</td>
                                    ...
                                    <td>{{ $ticket->close_status }}</td>
                                    <td>{{ $ticket->user_close_status }}</td>
                                    <td>{{ $ticket->status }}</td>
