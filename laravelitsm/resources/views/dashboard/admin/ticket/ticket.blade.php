                        ...
                        <div class="card-body">
                            ...
                            <table class="datatable table-bordered datatable-head-custom" id="kt_datatable">
                                ...
                                <tr >
                                    ...
                                    <th title="Field #2" >&nbsp;&nbsp;Ticket Date</th>
                                    <th title="Field #3" >&nbsp;&nbsp;Ticket Type</th>
                                    <th title="Field #4" >&nbsp;&nbsp;Created By User</th>
                                    <th title="Field #4" >&nbsp;&nbsp;Summary</th>
                                    <th title="Field #5" >&nbsp;&nbsp;Level</th>
                                    <th title="Field #6" >&nbsp;&nbsp;Severity</th>
                                    <th title="Field #7" >&nbsp;&nbsp;Consultant</th>
                                ...
                                @foreach($tickets as $ticket)
                                        <tr>
                                            <td style="margin-left:15px;">{{ $ticket->project }}_{{ $ticket->modulename }}_{{ date('my', strtotime($ticket->created_at)) }}_{{ $ticket->id }}</td>
                                            <td>{{ $ticket->created_at }}</td>
                                            
                                            <td class="text-center">{{ $ticket->type}} Request</td>
                                            <td>{{ $ticket->created_by }}</td>
                                            <td class="text-center">{{ $ticket->summary }}</td>
                                            <td class="text-center">{{ $ticket->level }}</td>
                                            <td class="text-center">{{ $ticket->severity }}</td>
                                            <td class="text-center">{{ $ticket->responsible }}</td>
                                            <td >{{ $ticket->status }}</td>
                                            <td><div class="row">
                                                    <div class="col">
                                                        <a href="ticket/{{ $ticket->id }}"  style="font-size: 12px; color:#2b2e32;margin-left:5px;" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
                                                    ...
                                                    <div class="col">
                                                        <a class="btn btn-sm btn-clean btn-icon del"  style="font-size: 12px; color:#2b2e32;margin-left:5px;" data-value="{{ $ticket->id }}" data-token="{{ csrf_token() }}" title="Delete Ticket">
	                                                        <span class="svg-icon svg-icon-md">
	                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="10px" height="24px" viewBox="0 0 24 24" version="1.1">
	                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
	                                                                    <rect x="0" y="0" width="24" height="24"/>
