...
@section('subhead')
    <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <div class="d-flex align-items-baseline flex-wrap mr-5">
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bolder my-1 mr-5" style="font-size:22px;">Consultant Dashboard</h5>
            <!--end::Page Title-->
        </div>
        <!--end::Page Heading-->
    </div>
  ...
  <div class="container">
        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                ...
                <div class="card-toolbar">
                    <a href="{{ route('consultant.ticket') }}" class="btn btn-primary font-weight-bolder font-size-sm">
            ...
            <div class="card-body py-0" style="padding-bottom:25px;">
                ...
                <img alt="Logo" style="height:100%;width:100%;" src="{{asset('assets/media/logos/consult.png')}}" />
                <!--<div class="table-responsive">-->
