    ...
    <div class="d-flex flex-row flex-column-fluid page">
        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="brand flex-column-auto" id="kt_brand">
                ...
                <!--begin::Logo-->
                <a href="{{ route('consultant.home') }}" class="brand-logo">
                   <img alt="Logo" style="height:30px;;width:100px;" src="{{asset('assets/media/logos/XCMG_logo1.png')}}" />  
                </a>
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                    ...
                    <ul class="menu-nav">
                        <li class="menu-item menu-item-active" aria-haspopup="true">
                            <a href="{{ route('consultant.home') }}" class="menu-link">
                        ...
                        <li class="menu-item" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="{{ route('consultant.ticket') }}" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
                        ...
                        <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                            ...
                            <ul class="menu-nav">
                                <li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here menu-item-active" data-menu-toggle="click" aria-haspopup="true">
                                    <a href="{{ route('consultant.home') }}" class="menu-link menu-toggle">
 <img alt="Logo" style="height:33px;;width:100px;" src="{{asset('assets/media/logos/XCMG_logo.png')}}" />                                        <!--<span class="menu-text">Dashboard</span>-->
...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
        <h3 class="font-weight-bold m-0">Consultant Profile
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"> Name : {{ Auth::guard('consultant')->user()->name }}</a>
                <div class="text-muted mt-1">Profile : Consultant</div>
                <div class="navi mt-1">
                    <a href="#" class="navi-item">
								<span class="navi-link p-0 pb-2">
									...
									<span class="navi-text text-muted text-hover-primary">{{ Auth::guard('consultant')->user()->email }}</span>
								</span>
                    </a>
                </div>
            </div>
         ...
         <!--   </a>-->
            ...
            <span class="navi-item mt-2">
						<span class="navi-link">
							<a href="{{ route('consultant.logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="btn btn-sm btn-light-primary font-weight-bolder py-3 px-6">Sign Out</a>
						</span>
                        <form action="{{ route('consultant.logout') }}" method="post" class="d-none" id="logout-form">@csrf</form>
					</span>
            <!--end:Item-->
        </div>
        <!--end::Nav-->
       ...
       <!--         </div>-->
                ...
                <!--begin::Description-->
                <!--<div class="ml-1">-->
                <!--    <h3 class="text-dark-75 font-weight-bolder font-size-lg">Important Noticessssssssssssss</h3>-->
