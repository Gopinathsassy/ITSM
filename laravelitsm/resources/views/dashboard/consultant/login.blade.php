...
<head><base href="../../../">
    ...
    <style>
        body {
            background-image: url({{ asset('assets/media/svg/illustrations/consultant.png') }}) ;
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-2 login-signin-on d-flex flex-column flex-column-fluid position-relative overflow-hidden" id="kt_login">
        <!--begin::Header-->
        <div class="login-header py-6 flex-column-auto">
...
<img alt="Logo" style="height:50px;;width:130px;padding-top:13px;" src="{{asset('assets/media/logos/XCMG_logo.png')}}" />                  </a>

                <!--end::Logo-->
            </div>
          <div class="container">
                <!--begin::Logo-->
                <a href="{{ route('user.login') }}" class=" py-md-0 col-lg-12">
<button class="btn font-weight-bold btn-primary mr-2" style="height:50px;;width:130px;padding-top:13px;float: right;">User</button>                  </a>

<a href="{{ route('consultant.login') }}" class=" py-md-0 col-lg-12">
<button class="btn font-weight-bold btn-primary mr-2" style="height:50px;;width:130px;padding-top:13px;float: right;">Consultant</button>                  </a>
<a href="{{ route('admin.login') }}" class=" py-md-0 col-lg-12">
<button class="btn font-weight-bold btn-primary mr-2" style="height:50px;;width:130px;padding-top:13px;float: right;">Admin</button>                  </a>
            ...
            <div class="container row">
                <div class="col-lg-6 d-flex align-items-center">
                    ...
                    <div class="login-form login-signin">
                        <!--begin::Form-->
                        <form class="form w-xxl-550px bg-white rounded-lg p-20" action="{{ route('consultant.check') }}" method="post" autocomplete="off">
                            @if(Session::get("Fail"))
                        ...
                        <!--begin::Title-->
                            <div class="pb-13 pt-lg-0 pt-5">
                                <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Consultant Login</h3>
                            </div>
                            <!--begin::Title-->
                            <!--begin::Form group-->
