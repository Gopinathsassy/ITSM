...
<div class="container">
    <div class="row">
        <div class="col-md-4 offset-md-4" style="margin-top: 50px">
            <h4>Consultant Register</h4><hr>
            <form action="{{ route('consultant.create') }}" method="post" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="department" value="{{ old('department') }}" placeholder="Enter the Department">
