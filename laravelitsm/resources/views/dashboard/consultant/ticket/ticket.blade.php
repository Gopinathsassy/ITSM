                        ...
                        <div class="card-body">
                            ...
                            <table class="datatable table-bordered datatable-head-custom" id="kt_datatable">
                                ...
                                @foreach($tickets as $ticket)
                                    @if($ticket->modulename == Auth::guard('consultant')->user()->department)
                                        <tr @if($ticket->assignedto == Auth::guard('consultant')->user()->name and ($ticket->status != '1' || $ticket->status != '2') ) class="table-success" @endif>
                                            ...
                                            <td><div class="row">
                                                    <div class="col">
                                                        @if(($ticket->status == '3' or $ticket->status == '4') and ($ticket->assignedto == Auth::guard('consultant')->user()->name ))
...
{{--                                                        @endif--}}
                                                            @elseif(($ticket->status != '3' and $ticket->status != '5' )  and $ticket->assignedto != Auth::guard('consultant')->user()->name)
                                                                <a href="ticket/{{ $ticket->id }}"  class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
	                                                        <span class="svg-icon svg-icon-md">
	                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="10px" height="24px" viewBox="0 0 24 24" version="1.1">
	                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
{{--                                                            @endif--}}
                                                            @elseif($ticket->status == '2' and $ticket->assignedto == Auth::guard('consultant')->user()->name)
                                                                <a href="ticket/{{ $ticket->id }}"  class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
	                                                        <span class="svg-icon svg-icon-md">
	                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="10px" height="24px" viewBox="0 0 24 24" version="1.1">
	                                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
