                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control consulssss"  name="consulsss" id="consulssss" rows="5"></textarea>
                                        <span class="text-danger">@error('description'){{ $message }}@enderror</span>
                                    </div>
                                </div>
                                        ...
                                        @else
                                            <div class="card card-custom overlay" >
                                                <div class="card-body p-0" >
                                                    <span style="width: 180px;height: 80px" class="label label-primary label-inline font-weight-boldest mr-2">No Screenshots Available for this ticket</span>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                ...
                <div class="card card-custom">
                    ...
                    <div class="card-footer align-items-center">
                        ...
                        <div class="d-flex align-items-center justify-content-between mt-5">
                            ...
                            <div>
                                <button type="button" class="btn btn-primary btn-md text-uppercase font-weight-bold py-2 px-6" id="msend">Sendsss</button>
                            </div>
                        </div>
                        <!--begin::Compose-->
                    </div>
