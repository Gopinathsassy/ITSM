...
@section('subhead')
    <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <div class="d-flex align-items-baseline flex-wrap mr-5">
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bolder my-1 mr-5" style="font-size:22px;">User Dashboard</h5>
            <!--end::Page Title-->
        </div>
        <!--end::Page Heading-->
    </div>
...
@section('content')
 <div class="container">
        ...
        <!--        <div class="card card-custom card-stretch gutter-b">-->
               ...
               <!--         <h3 class="card-title">-->
               <!--             <span class="card-label font-weight-bolder font-size-h4 text-dark-75">Weekly Salesssssssss</span>-->
               <!--         </h3>-->
        ...
        <div class="card card-custom gutter-b">
            ...
            <div class="card-header border-0 py-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label font-weight-bold font-size-h4 text-dark-75">ITSM (IT Service Management)</span>
                    <span class="text-muted mt-3 font-weight-bold font-size-sm">includes the processes and technology used to plan, deliver, and support IT services.</span>
                </h3>
                <div class="card-toolbar">
                    <a href="{{ route('user.ticket') }}" class="btn btn-primary font-weight-bolder font-size-sm">
            ...
            <!--end::Header-->
            <!--begin::Body-->
            <div class="card-body py-0" style="padding-bottom:25px;">
                <!--begin::Table-->
                <!--style="background-image: url({{asset('assets/media/users/cam.png')}})"-->
                <img alt="Logo" style="height:100%;width:100%;" src="{{asset('assets/media/logos/user.png')}}" />
                <!--<div class="table-responsive">-->
...
<!--                <div class="card-header border-0 pt-6">-->
<!--                    <h3 class="card-title">-->
<!--                        <span class="card-label font-weight-bolder font-size-h4 text-dark-75">Weekly Ticketsssssssssssssssssssss</span>-->
<!--                    </h3>-->
<!--                </div>-->
                <!--end::Header-->
                <!--begin::Body-->
<!--                <div class="card-body d-flex align-items-start justify-content-between  pt-7 flex-wrap">-->
                    <!--begin::label-->
<!--                    <span class="font-weight-bolder display5 text-dark-75 py-4 pl-5 pr-5">-->
<!--												<span class="font-weight-normal font-size-h6 text-muted pr-1"></span>{{ $ticket_week_count }}</span>-->
                    <!--end::label-->
                    <!--begin::Chart-->
<!--                    <div class="progress-vertical justify-content-start w-200px h-125px">-->
<!--                        @foreach($ticket_days as $ticket_day)-->
<!--                                <div class="progress bg-light-primary" data-toggle="tooltip" title="{{ $ticket_day->dayname ." : ". $ticket_day->count }}">-->
<!--                                    <div class="progress-bar bg-primary" role="progressbar" style="height: {{ $ticket_day->count }}%" aria-valuenow="{{ $ticket_day->count }}" ></div>-->
<!--                                </div>-->
<!--                        @endforeach-->
<!--                    </div>-->
                    <!--end::Chart-->
...
<!--                <div class="card-header border-0 pt-6">-->
<!--                    <h3 class="card-title">-->
<!--                        <span class="card-label font-weight-bolder font-size-h4 text-dark-75">Ticket Type Wise</span>-->
<!--                    </h3>-->
<!--                </div>-->
                <!--end::Header-->
                <!--begin::Body-->
<!--                <div class="card-body d-flex align-items-center justify-content-between pt-7 flex-wrap">-->
                    <!--begin::Label-->
<!--                    <span class="font-weight-bolder display5 text-dark-75 pl-5 pr-10">{{ $tktcount }}</span>-->
                    <!--end::Label-->
                    <!--begin::Visuals-->
<!--                    <div class="d-flex align-items-center justify-content-between">-->
                        <!--begin::legends-->
<!--                        <div class="d-flex flex-column mr-4">-->
                            <!--begin::legend-->
<!--                            <div class="legend d-flex align-items-center py-1">-->
<!--                                <span class="label label-dark-50 label-dot label-primary mr-2"></span>-->
<!--                                <span class="font-weight-bolder font-size-lg text-muted">Incident</span>-->
<!--                            </div>-->
                            <!--end::legend-->
                            <!--begin::legend-->
<!--                            <div class="legend d-flex align-items-center py-1">-->
<!--                                <span class="label label-dark-75 label-dot label-secondary mr-2"></span>-->
<!--                                <span class="font-weight-bolder font-size-lg text-muted">Service</span>-->
<!--                            </div>-->
                            <!--end::legend-->
                            <!--begin::legend-->
<!--                            <div class="legend d-flex align-items-center py-1">-->
<!--                                <span class="label label-dot label-warning mr-2"></span>-->
<!--                                <span class="font-weight-bolder font-size-lg text-muted">Change</span>-->
<!--                            </div>-->
                            <!--end::legend-->
<!--                        </div>-->
                        <!--end::legends-->
                        <!--begin::Chart-->
<!--                        <div class="d-flex flex-center position-relative">-->
<!--                            <div class="font-weight-bolder font-size-h5 text-muted position-absolute">{{ $tktcount }}</div>-->
<!--                            <canvas id="kt_stats_widget_2_chart" style="height: 110px; width: 110px;"></canvas>-->
<!--                        </div>-->
                        <!--end::Chart-->
<!--                    </div>-->
